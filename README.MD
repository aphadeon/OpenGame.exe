...
**Important:** If you are on a Unix operating system, please set the executable bit for the file
*/Tools/assemble.bat* as otherwise you will not get a complete product on building.
